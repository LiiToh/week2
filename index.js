...
const reusltArea = document.querySelector(".result");
...
switch(userChoice) {
    ...
    case "yellow":
        ...
        break;
    case "black":
        "You are a strong-willed, determined, confident, independent, risk-taker kind of individual.";
        break;
    case "pink":
        "You are a playful, fun, easy-going, smart, genuine child-like, social butterfly kind of individual.";
        break;
    case "blue":
    ...
    reusltArea.innerHTML = resultText;
